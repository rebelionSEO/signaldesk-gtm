...
import { EvaluationBoard } from '@/components/gtm-v2';
...
export default function Home() {
 ...
 <TabsContent value="system"><EvaluationBoard planner={study?.planner ?? null} traces={study?.trace ?? []} report={report}/></TabsContent>
