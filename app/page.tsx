...
export default function Home() {
 ...
 <TabsContent value="economics" forceMount hidden={tab!=='economics'}><PipelineBudget key={study?.id??'example'} report={report} canSave={!!editable} onSave={async model=>{await save({...report,economics:[...(report.economics??[]).filter(m=>m.experimentId!==model.experimentId),model]});}}/></TabsContent>
