...
import { SystemBoard } from '@/components/gtm-v2';
...
export default function Home() {
 ...
 <Tabs value={tab} onValueChange={setTab}><TabsList className="tabbar v3-tabbar" variant="line"><TabsTrigger value="overview">Command</TabsTrigger><TabsTrigger value="strategy">Strategy</TabsTrigger><TabsTrigger value="plan">Ideas <span>{report.opportunities.length}</span></TabsTrigger><TabsTrigger value="execution">Operations <span>{study?.operations.tasks.length ?? 0}</span></TabsTrigger><TabsTrigger value="evidence">Evidence <span>{report.evidence.length}</span></TabsTrigger></TabsList>
